...
void Blob::predictNextPosition(void) {
    ...
    if (numPositions == 1) {
        ...
        int deltaX = (int)round((double)sumOfXChanges / 3.0);

        int sumOfYChanges = ((centerPositions[2].y - centerPositions[1].y) * 2) +
            ((centerPositions[1].y - centerPositions[0].y) * 1);

        int deltaY = (int)round((double)sumOfYChanges / 3.0);
        ...
        int deltaX = (int)round((double)sumOfXChanges / 6.0);

        int sumOfYChanges = ((centerPositions[3].y - centerPositions[2].y) * 3) +
            ((centerPositions[2].y - centerPositions[1].y) * 2) +
            ((centerPositions[1].y - centerPositions[0].y) * 1);

        int deltaY = (int)round((double)sumOfYChanges / 6.0);
        ...
        int deltaX = (int)round((double)sumOfXChanges / 10.0);
        ...
        int deltaY = (int)round((double)sumOfYChanges / 10.0);
